...
11 mis-assignments, but only 6 with a scaled-likelihood > 0.9 and two are Lehua, which only has two individuals in the baseline, so probably not great representation for that colony. Maybe also suggesting that the Lehua colony was formed by birds from Midway...?
