...
```
63 samples had >25% missing data
...
768 bycatch birds (this is the 959-63 with missing data, -129 in the reference populations)
...
78.9% of bycatch assigned at >90%
...
All of the birds with low z-scores look like they're closest to Laysan. None have a lot of missing loci... I wonder if there are some fixed differences?
...
bycatch_assignments %>%
  write_csv("csv_outputs/BFAL_bycatch_assignments_20230403.csv")
```
