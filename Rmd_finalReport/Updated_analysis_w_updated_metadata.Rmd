...
final_bycatch_prop <- colony_assignments %>%
...
bycatchB <- bycatch_diff %>%
  ...
  labs(
    color = "Bycatch \ncolony of origin",
    y = "Difference bycatch-population prop.",
    x = " "
  ) +
...
ggsave(plot=p3,"pdf_outputs/BFAL_UDs_3panels_619birds.png", width = 8, height = 4)
